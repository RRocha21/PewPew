...
/* Cores para Hud */
/*
var t_color = "182,135,50";
var ct_color = "1, 112, 177";
var dark_ct_color = "0,33,71";
var dark_t_color = "67,42,33";
var warning = "255, 79, 79";
*/
/* //old colors for spring mucha
var t_color = "254,60,199";
var ct_color = "31,193,162";
var dark_ct_color = "9, 57, 48";
//var dark_ct_color = "11,72,60";
var dark_t_color = "76,0,55";
//var dark_t_color = "92,24,72";
var warning = "255, 79, 79";
*/
var t_color = "255, 206, 0";
var ct_color = "0, 210, 207";
var dark_ct_color = "0, 51, 50";
var dark_t_color = "51, 41, 0";

var warning = "255, 118, 122";
var dark_warning = "51, 0, 2";
...
function fillObserved(player) {
    ...
    if (player.team == "CT" && teams.left.side == "ct") {
        ...
        $(".observed_container").css("background", "rgba(" + dark_ct_color + ", 0.7)");
        ...
        $(".observed_container").css("background", "rgba(" + dark_t_color + ", 0.7)");
...
function fillPlayer(player, nr, side, max) {
    ...
    if (side == "right") {
        if (team == "ct") {
            health_color = "linear-gradient(-90deg, rgba(" + ct_color + ", 0.3) 0px, rgba(" + ct_color + ", 0.7) 143px, rgba(" + ct_color + ", 1) 330px)";
            ...
            $(".players_right_container>.player_container").css("background", "linear-gradient(to left, rgba(" + dark_ct_color + ", 0.7) 100%, transparent 100%)");
        } else {
            health_color = "linear-gradient(-90deg, rgba(" + t_color + ", 0.3) 0px, rgba(" + t_color + ", 0.7) 143px, rgba(" + t_color + ", 1) 330px)";
            ...
            $(".players_right_container>.player_container").css("background", "linear-gradient(to left, rgba(" + dark_t_color + ", 0.7) 100%, transparent 100%)");
        }
    }
    ...
    if (side == "left") {
        if (team == "ct") {
            ...
            $(".players_left_container>.player_container").css("background", "linear-gradient(to right, rgba(" + dark_ct_color + ", 0.7) 100%, transparent 100%)");
        } else {
            health_color = "linear-gradient(90deg, rgba(" + t_color + ", 0.3) 0px, rgba(" + t_color + ", 0.7) 143px, rgba(" + t_color + ", 1) 330px)";
            ...
            $(".players_left_container>.player_container").css("background", "linear-gradient(to right, rgba(" + dark_t_color + ", 0.7) 100%, transparent 100%)");
        }
    }
...
function updatePage(data) {
    ...
    if (teams.left.side == "ct" && teams.right.side == "t") {
        ...
        $(".header_container>.inner").css("background", "linear-gradient(90deg, rgba(" + dark_ct_color + ",0.8) 0%, rgba(" + dark_t_color + ",0.8) 100%)");
        ...
        $(".header_container>.inner").css("background", "linear-gradient(90deg, rgba(" + dark_t_color + ",0.8) 0%, rgba(" + dark_ct_color + ",0.8) 100%)");
    ...
    $(".right_bonus").css("background", "rgba(" + dark_right_color + ", 0.65)");
    ...
    $(".left_bonus").css("background", "rgba(" + dark_left_color + ", 0.65)");
    ...
    $(".firepower_money_left>.team_container").css("background", "rgba(" + dark_left_color + ", 0.65)");
    $(".firepower_money_left>.team_container>.text_money").css("background", "rgba(" + left_color + ", 0.8)");
    $(".firepower_money_left>.team_container").css("border", "solid 2px rgb(" + left_color + ")");
    $(".firepower_money_left>.equip_container").css("background", "rgba(" + dark_left_color + ", 0.65)");
    $(".firepower_money_left>.equip_container>.text_money").css("background", "rgba(" + left_color + ", 0.8)");
    ...
    $(".firepower_money_right>.team_container").css("background", "rgba(" + dark_right_color + ", 0.65)");
    $(".firepower_money_right>.team_container>.text_money").css("background", "rgba(" + right_color + ", 0.8)");
    $(".firepower_money_right>.team_container").css("border", "solid 2px rgb(" + right_color + ")");
    $(".firepower_money_right>.equip_container").css("background", "rgba(" + dark_right_color + ", 0.65)");
    $(".firepower_money_right>.equip_container>.text_money").css("background", "rgba(" + right_color + ", 0.8)");
    ...
    $(".alerts_container > .left > .background").css("background", "rgba(" + dark_left_color + ", 1)");
    $(".left_name").css("color", "rgb(" + left_color + ")");
    $(".left_score").css("color", "rgb(" + left_color + ")");
    $(".player_count_left").css("color", "rgb(" + left_color + ")");
    $(".player_count_left").css("background", "rgba(" + dark_left_color + ", 0.5)");
    ...
    $(".spam > .left_container").css("background", "rgba(" + dark_left_color + ", 0.65)");
    ...
    $(".alerts_container > .right > .background").css("background", "rgba(" + dark_right_color + ", 1)");
    ...
    $(".player_count_right").css("background", "rgb(" + dark_right_color + ", 0.5)");

    $(".spam > .right_container").css("background", "rgba(" + dark_right_color + ", 0.65)");
