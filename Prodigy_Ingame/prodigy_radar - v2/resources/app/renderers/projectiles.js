...
socket.element.addEventListener("projectiles", event => {
	...
	for (let projectile of projectiles) {
		...
		if (!projectileElement) {
			...
			trailElement.setAttributeNS(null, "stroke-width", global.mapData.resolution * 0.1)
			// Color it with the team colors
			trailElement.setAttributeNS(null, "stroke", projectile.team == "T" ? "#fe3ec766" : "#1fc1a266")
